...
public class PacManView extends Group {
     ...
     */
    public PacManView() {
        this.pacmanRightImage = new Image(getClass().getResourceAsStream("/gambar/pacmanRight.gif"));
        this.pacmanUpImage = new Image(getClass().getResourceAsStream("/gambar/pacmanUp.gif"));
        this.pacmanDownImage = new Image(getClass().getResourceAsStream("/gambar/pacmanDown.gif"));
        this.pacmanLeftImage = new Image(getClass().getResourceAsStream("/gambar/pacmanLeft.gif"));
        this.ghost1Image = new Image(getClass().getResourceAsStream("/gambar/redghost.gif"));
        this.ghost2Image = new Image(getClass().getResourceAsStream("/gambar/ghost2.gif"));
        this.blueGhostImage = new Image(getClass().getResourceAsStream("/gambar/blueghost.gif"));
        this.wallImage = new Image(getClass().getResourceAsStream("/gambar/wall.png"));
        this.bigDotImage = new Image(getClass().getResourceAsStream("/gambar/whitedot.png"));
        this.smallDotImage = new Image(getClass().getResourceAsStream("/gambar/smalldot.png"));
    }
    ...
    public void updatePacman(int x, int y, PacManModel.Direction direction) {
    // Logika untuk memperbarui posisi Pac-Man di tampilan
    this.cellViews[y][x].setImage(this.pacmanRightImage); // Contoh gambar
    }

       public void updateGhost(int x, int y, PacManModel.Direction direction) {
    // Logika untuk memperbarui posisi Ghost di tampilan
    this.cellViews[y][x].setImage(this.ghost1Image); // Contoh gambar
    }
